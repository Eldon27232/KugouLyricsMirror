...
internal sealed class ControlForm : Form
{
    ...
    private readonly CheckBox _vrOverlayMode = new() { Text = "高级：VR 叠加模式", Checked = true, AutoSize = true };
    ...
    public ControlForm()
    {
        ...
        AddRow("选项", new FlowLayoutPanel { AutoSize = true, Controls = { _topMost, _excludeFromCapture, _vrOverlayMode } });
        ...
        _vrOverlayMode.CheckedChanged += (_, _) => VrOverlayModeChanged();
    ...
    private void LoadConfigToUi()
    {
        ...
        _vrOverlayMode.Checked = AppConfig.Current.WindowVrOverlayMode;
    ...
    private bool SaveUiToConfig()
    {
        ...
        AppConfig.Current = new Config
        {
            ...
            WindowVrOverlayMode = _vrOverlayMode.Checked,
            WindowFollowSourceWindow = _vrOverlayMode.Checked,
            WindowClickThrough = _vrOverlayMode.Checked,
    ...
    private void UpdateModeUi()
    {
        ...
        _vrOverlayMode.Enabled = isWindowCapture;
        _vrOverlayMode.Visible = isWindowCapture;
    ...
    private void VrOverlayModeChanged()
    {
        AppConfig.Current.WindowVrOverlayMode = _vrOverlayMode.Checked;
        ApplyToPreview();
    }
